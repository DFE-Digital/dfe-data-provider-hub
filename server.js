...
// add HMCTS Design system references
app.use(
	'/hmcts',
	express.static(path.join(__dirname, '/node_modules/@hmcts/frontend'))
)

// add HMCTS Design system references
app.use(
	'/hmcts-assets',
	express.static(path.join(__dirname, '/node_modules/@hmcts/frontend/assets'))
)
